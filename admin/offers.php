  ...
  <span style="font-size:30px;cursor:pointer;color: black;" onclick="openNav()"><i class="fas fa-bars"></i></span>
			...
			<div id="contents">
				<div class="box">
					<div>
						...
						<table>
								  ...
								  <span style="color:white; font-family:Times New Roman; font-size:12px;">*<?php echo $rcamtErr;?></span>
									</td>
										</tr>
										<tr>
											<td> Talktime:</td>
                                ...
                                <span style="color:white; font-family:Times New Roman; font-size:12px;">*<?php echo $tktmErr;?></span>
                                ...
                                <span style="color:white; font-family:Times New Roman; font-size:12px;">*<?php echo $valErr;?></span>
			  ...
			  ?>
                      ...
                      <span style="color:white; font-family:Times New Roman; font-size:12px;">*<?php echo $oprtrErr;?></span>
</td>
										</tr>
										 <tr>
											<td></td>
                                       ...
                                       <button name="cancel" type="submit" class="cancelbtn">Cancel</button>
										...
										<tr>
										<td >
										<a  href="dthoffers.php" style="color:white;">DTH Offers</a></td>
										</tr>
									</tbody>
								</table>
                             </form>
